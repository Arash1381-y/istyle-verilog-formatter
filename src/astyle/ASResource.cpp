...
namespace astyle {
    ...
    const string ASResource::AS_TAG = string("#");
    ...
    const string ASResource::AS_PARAM_DEC_START = string("#(");
    const string ASResource::AS_PAREN = string("(");
    const string ASResource::AS_PAREN_CLOSE = string(")");
